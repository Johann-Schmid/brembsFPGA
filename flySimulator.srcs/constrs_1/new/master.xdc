...
#set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33     } [get_ports { jb[2] }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33     } [get_ports { jb[3] }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { jb[4] }]; #IO_L19P_T3_34 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33     } [get_ports { jb[5] }]; #IO_L24N_T3_34 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33     } [get_ports { jb[6] }]; #IO_L24P_T3_34 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { jb[7] }]; #IO_L23N_T3_34 Sch=jb_n[4]
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33     } [get_ports { jb[8] }]; #IO_L23P_T3_34 Sch=jb_p[4]


##Pmod header JC
#set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33     } [get_ports { jc[1] }]; #IO_L18N_T2_34 Sch=jc_n[1]
#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { jc[2] }]; #IO_L18P_T2_34 Sch=jc_p[1]
#set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33     } [get_ports { jc[3] }]; #IO_L22N_T3_34 Sch=jc_n[2]
#set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33     } [get_ports { jc[4] }]; #IO_L22P_T3_34 Sch=jc_p[2]
#set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33     } [get_ports { jc[5] }]; #IO_L17N_T2_34 Sch=jc_n[3]
#set_property -dict { PACKAGE_PIN R6    IOSTANDARD LVCMOS33     } [get_ports { jc[6] }]; #IO_L17P_T2_34 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN AB6   IOSTANDARD LVCMOS33     } [get_ports { jc[7] }]; #IO_L20N_T3_34 Sch=jc_n[4]
#set_property -dict { PACKAGE_PIN AB7   IOSTANDARD LVCMOS33     } [get_ports { jc[8] }]; #IO_L20P_T3_34 Sch=jc_p[4]


##XADC Header
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33     } [get_ports { xa_n[1] }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33     } [get_ports { xa_p[1] }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33     } [get_ports { vauxn0 }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33     } [get_ports { vauxp0 }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
#set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33     } [get_ports { xa_n[3] }]; #IO_L2N_T0_AD8N_15 Sch=xa_n[3]
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33     } [get_ports { xa_p[3] }]; #IO_L2P_T0_AD8P_15 Sch=xa_p[3]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33     } [get_ports { xa_n[4] }]; #IO_L5N_T0_AD9N_15 Sch=xa_n[4]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33     } [get_ports { xa_p[4] }]; #IO_L5P_T0_AD9P_15 Sch=xa_p[4]
...
#set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { prog_d0/sck }]; #IO_L11P_T1_SRCC_14 Sch=prog_d0/sck
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { prog_d1/mosi }]; #IO_L19P_T3_A10_D26_14 Sch=prog_d1/mosi
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { prog_d2/miso }]; #IO_L22P_T3_A05_D21_14 Sch=prog_d2/miso
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { prog_d3/ss }]; #IO_L18P_T2_A12_D28_14 Sch=prog_d3/ss
